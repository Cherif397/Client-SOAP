...
public class ObjectFactory {
    ...
    private final static QName _ListeCompte_QNAME = new QName("http://ws/", "listeCompte");
    private final static QName _ListeCompteResponse_QNAME = new QName("http://ws/", "listeCompteResponse");
